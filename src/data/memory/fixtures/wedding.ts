...
export const weddingSeed: Seed = {
  ...
  approvedPhotos: [30, 200, 120, 280, 60, 340, 170, 20, 240].map((hue, i) => ({
    ...
    hue,
    localUri: null, progress: null, failureReason: null, storagePath: null, thumbPath: null, displayUrl: null,
    createdAt: at('19:0' + ((i % 9) + 0)),
  })),
  pendingPhotos: [
    { id: 'pho_1', folderId: 'fld_reception', uploadedByGuestId: 'gst_priya', uploadedByName: 'Priya', status: 'pending', hue: 30, localUri: null, progress: null, failureReason: null, storagePath: null, thumbPath: null, displayUrl: null, createdAt: minutesAgo(0) },
    { id: 'pho_2', folderId: 'fld_reception', uploadedByGuestId: 'gst_tom', uploadedByName: 'Tom', status: 'pending', hue: 200, localUri: null, progress: null, failureReason: null, storagePath: null, thumbPath: null, displayUrl: null, createdAt: minutesAgo(1) },
    { id: 'pho_3', folderId: 'fld_reception', uploadedByGuestId: 'gst_lou', uploadedByName: 'Grandpa Lou', status: 'pending', hue: 120, localUri: null, progress: null, failureReason: null, storagePath: null, thumbPath: null, displayUrl: null, createdAt: minutesAgo(3) },
  ],
