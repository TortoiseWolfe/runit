 ...
 *
 * IT IS A FLOOR, SO ONLY AN UNDERCOUNT FAILS. 108 = 101 measured in a whole-file run plus
 * the 7 storage assertions measured in an equivalent in-context run (the file is now large
